 ...
 * @version $Id:$
 */
public class ExoCacheEntityRegion extends ExoCacheTransactionalDataRegion implements EntityRegion
{

   public ExoCacheEntityRegion(ExoCache<Serializable, Object> cache, CacheDataDescription metadata)
   {
