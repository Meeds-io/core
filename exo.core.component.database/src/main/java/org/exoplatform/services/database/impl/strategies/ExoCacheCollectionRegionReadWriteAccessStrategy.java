 ...
 * @version $Id:$
 */
public class ExoCacheCollectionRegionReadWriteAccessStrategy extends ExoCacheAccessStrategy implements
   CollectionRegionAccessStrategy
{

   public ExoCacheCollectionRegionReadWriteAccessStrategy(ExoCacheTransactionalDataRegion region)
   {
      super(region);
   }
